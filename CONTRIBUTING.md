...
contributing to Finance, these are documented below.

### Project Code Style.

Code in Finance should conform to PEP8 and style/lint checks are run to validate
...
Source](https://qiskit.org/documentation/contributing_to_qiskit.html#installing-finance-from-source)
section of the Qiskit documentation.

Note: Finance depends on Ignis and Terra, and has optional dependence on Aer and IBM Q Provider, so
these should be installed too. The master branch of Finance is kept working with those other element
...
The master branch is used for development of the next version of qiskit-finance.
